...
export default function HomeScreen2() {
  ...
  return (
    <div className="mt-5 flex flex-col items-center justify-center">
      <p ref={pRef} className="text-center text-4xl md:text-6xl font-bold scale-50 duration-1000 sticky top-[80px]">My Skills</p>
      <div className="flex w-full lg:w-[50%] px-1 justify-center flex-wrap duration-1000">
        {
          icons.map((item) => {
            return (
                ...
                >
                  <div className="flex w-full items-center">
                    ...
                    <div className="w-2/4 flex justify-center align-center flex-col p-2">
                      <p className="text-2xl font-semibold text-center md:text-6xl">{item.name}</p>

...
export default function Footer() {
  ...
  return (
    <div className={`min-h-[40vh] w-full border-t-1 backdrop-blur-xl flex flex-col items-center ${themeSwitcher === 'dark' ? 'border-slate-800  bg-[#00000058]' : 'border-slate-200 bg-[#ffffff58]'}`}>
        ...
        <div className="flex justify-center w-9/12 flex-col md:flex-row gap-5">
          ...
          <div className="w-full md:w-1/2">
            ...
            <div className="flex gap-2 my-2 mb-4 flex-wrap">
              <NextjsIcon size={30} />
              <TypescriptIcon size={30} color={themeSwitcher === "dark" ? "#ffffff" : "#000000"} />
              <JavaScriptIcon size={30} color={themeSwitcher === "dark" ? "#ffffff" : "#000000"} />
              <HtmlIcon size={30} color={themeSwitcher === "dark" ? "#ffffff" : "#000000"} />
              <CssIcon size={30} color={themeSwitcher === "dark" ? "#ffffff" : "#000000"} />
              <TailwindIcon size={30} color={themeSwitcher === "dark" ? "#ffffff" : "#000000"} />
              <ReactJSIcon size={30} color={themeSwitcher === "dark" ? "#ffffff" : "#000000"} />
              <ArchLinuxIcon size={30} color={themeSwitcher === "dark" ? "#ffffff" : "#000000"} />
            </div>
            <p className="font-semibold">Contact Me</p>
            <div className="flex gap-2 my-2">
              <a href="https://www.linkedin.com/in/yusuf-juanda-283015218/" target="_blank"><LinkedInIcon size={30} color={themeSwitcher === "dark" ? "#ffffff" : "#000000"} /></a>
              ...
              <a href="https://github.com/juandaYusuf" target="_blank"><GithubIcon size={35} color={themeSwitcher === "dark" ? "#ffffff" : "#000000"} /></a>
